...
async def start(client,message):
	...
	await message.reply_text("Hello iam Pdisk Uploader Bot\nMade with love by @jetbots",reply_to_message_id = message.message_id,reply_markup=InlineKeyboardMarkup([ [ InlineKeyboardButton("Channel 🇮🇳" ,url="https://t.me/jetbots") ], [InlineKeyboardButton("Developer 🧐", url="https://t.me/jettastic") ]  ]  ) 
        )
